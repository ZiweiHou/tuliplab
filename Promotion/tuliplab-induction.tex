...
\selectcolormodel{rgb}
\tikzstyle{block} = [rectangle, draw=orange, text width=7em, text centered, rounded corners, minimum height=4em]
\tikzstyle{line} = [draw, -latex']
\begin{tikzpicture}[node distance =4cm, auto]
	\node[block](generateItem){Generating Targeted Item-set};
	\node[block, left of=generateItem](initialTransData){Transcation Data};
	...
	\node[block, below of=candiNegItem](interNegItem){Interesting Negative Item-set};
	\node[block, right of=interNegItem](negRule){Negative Rules};
	\node[block, right of=generateItem](candiPosItem){Candidate Interesting\textbf{Positive}Item-set};
	\node[block, right of=candiPosItem](interPosItem){Interesting Positive Item-set};
	\node[block, below of=interPosItem](posRule){Positive Rules};
...
\begin{itemize}
	...
	{
		\begin{figure}[htbp]
			\includegraphics[width=0.7\textwidth]{figures//theme3//Theme3_3_1.eps}
		\end{figure}
	}
...
%%==========================================================================================
%%
\begin{slide}{Case Study (4) - Heterogeneous Preferences}
...
%%==========================================================================================
%%
\begin{slide}{Case Study (5) - PR Based Conditional Random Fields}

...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Organization}
\selectcolormodel{rgb}
\twocolumn[
...
\selectcolormodel{rgb}
  ...
  node[root,scale=0.6, text=white] {Training at TULIP} [clockwise from=187]
    child[concept color=orange!60] {
    ...
    child[concept color=blue!60] {
      ...
      child { node[concept,scale=0.6] (Reviewteam){Review}}
      child { node[concept,scale=0.6] (present){Presentation}}
      child { node[concept,scale=0.6] (write){Writing}}
    }
   ;
...
%      \item FLIP(05): Learning Theory (II)
%    }
%    \info{TeXampleBlog.north east}{above,anchor=west,xshift=0.5em}{%
%      \item QQ Online
%      \item At least once a month
%      \item Read material before meeting
%      \item Ask questions.
...
descriptive items y sep = 3.1
}
\smartdiagram[priority descriptive diagram]{TULIP Academy
\begin{enumerate}
\item You can't be absent from the meeting without permission
         \item Xi'an group members must attend the seminar in the lab but not online
         \item Collaborate with team members rather than attacking each other
\end{enumerate}, FLIP Study \begin{enumerate}
         \item All FLIP students need to pass the corresponding prerequisite
         \item All FLIP materials are confidential \, you can't circulate them outside
         \end{enumerate}, Research \begin{enumerate}
         \item \texttt{SmartGit} \, \texttt{Bitbucket} \, \texttt{Mendeley} \, and update PPR in time
         \item Actively discuss research work in the group meeting and TULIP seminar
         \item Everyone should prepare at least one question for each TULIP seminar
\end{enumerate}}
\end{center}
\end{slide}
%%

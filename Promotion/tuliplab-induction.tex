...
\selectcolormodel{rgb}
   \begin{tikzpicture}[ every annotation/.style = {draw,
                     fill = white}]
  \path[mindmap,concept color=pink!40,text=white,
    ...
    level 2 concept/.append style={font=\sf,text width=7em,inner sep=0pt},
  ]
  node[root,scale=0.6] {Research Themes} [clockwise from=180]
    child[concept color=green!60] {
      node[scale=0.6] {Behavior Informatics} [clockwise from=200]
        child { node[scale=0.6] (pre){Periodic Behavior Mining}}
...
%	TABLE 6. Privacy breach of Singapore residents traveling overseas\protect\footnotemark[1].\\[15pt]
	...
	\onslide*{4,5}{\textcolor{orange}{${L_11}$}}\onslide*{-3}{{$L_{11}$}}	
	&\onslide*{4,5}{\textcolor{orange}{$U_5$(M)-$U_6$(F)}}\onslide*{-3}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{4,5}{\textcolor{orange}{Ho Chi Minh, Vietnam}}\onslide*{-3}{{Ho Chi Minh, Vietnam}} 	
...
\begin{tikzpicture}
    ...
    (2012,5)(2013,12)(2014,12)(2015,11)(2016,6)(2017,9)(2018,10)
    };
...
\begin{table}[htbp]
  \centering
    ...
    \textbf{2014} & Best Student Paper Award & Tianqing Zhu &  \\

    \textbf{2012} & 2012 ACM ASONAM Best Paper Award & Yongli Ren &  \\

    \textbf{2007} & Springer Nightingale Prize & Jingyu Hou &  \\
    \bottomrule
    \end{tabular}
  \label{tab:addlabel}
\end{table}
...
\begin{figure}[htbp]
    ...
    \subfigure{
        \includegraphics[width=0.3\textwidth]{figures//awards//TULIPAwards2016A.eps}
    }
    \subfigure{
        \includegraphics[width=0.3\textwidth]{figures//awards//TULIPAwards2014.eps}
    }
    \subfigure{

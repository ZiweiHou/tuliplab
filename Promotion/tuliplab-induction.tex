...
{$\infty$, \begin{enumerate}
         \item Research meeting with supervisor twice a week
         \item Complete FLIP (04) and FLIP (05)
         \end{enumerate}},
{Trainee, \begin{enumerate}
         \item Complete  FLIP (02) FLIP (03) with Kaggle projects
         \item Presentation at TULIP Seminar
         \item SmartGit \, Bitbucket and Mendeley
         \end{enumerate}},
%\vspace{0.5cm}
{Flipper,\begin{enumerate}
\item Complete FLIP (00) FLIP (01) with test on Kaggle projects
         \item Read materials before every TULIP Seminar and ask questions
         \item Learn \LaTeX{}
         \item Schedule work and progress using PPR \end{enumerate}},}
\end{center}

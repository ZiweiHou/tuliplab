...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Deakin Rankings}
\begin{table}[htbp]
...
\begin{itemize}
  \item \textcolor{orange}{\faHome:} \href{http://www.tulip.org.au}{http://www.tulip.org.au}
  \begin{itemize}
    \item \textcolor{orange}{\faTwitter}: tulipacademy
    \item \textcolor{orange}{\faWeibo}: \href{https://weibo.com/tulipacademy}{https://weibo.com/tulipacademy}
  \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Detect the emotion based on acoustic signal without sematic analysis
...
\begin{slide}[toc=,bm=]{Case Study (6) - Trajectory Analysis}
\begin{figure}[ht]
  \includemovie[poster=figures//theme1//Theme1_23.eps,inline=false]{13cm}{10cm}{figures//theme1//vs.avi}
\end{figure}
\end{slide}
%%
%%==========================================================================================
...
\setlength{\belowcaptionskip}{12pt}
\caption{Publications from TULIP Lab}

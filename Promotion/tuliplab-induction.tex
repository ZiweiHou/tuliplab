...
\begin{slide}[toc=,bm=]{Case Study (2) - Contrast Mining}
	...
	\tikzstyle{vecArrow} = [thick, fill=blue!10, decoration={markings,mark=at position 1 with {\arrow[semithick]{open triangle 60}}}, double distance=1.4pt, shorten >= 5.5pt, preaction = {decorate}, postaction = {draw,line width=1.4pt, white,shorten >= 4.5pt}]
	...
	\begin{itemize}
		...
		\twocolumn[lcolwidth=0.5\linewidth,rcolwidth=0.5\linewidth,colsep=0.001\linewidth]{
			\begin{center}
				\onslide*{3, 3-}{
					\begin{large}
						\Large \textcolor{yellow}\faStar \faStar \faStar \faStar \faStar
					\end{large}
					10 years ago
				}
			\end{center}

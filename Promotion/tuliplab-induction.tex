...
\begin{slide}[toc=,bm=]{Case Study (2) - Contrast Mining}
	\selectcolormodel{rgb}
	\usetikzlibrary{positioning}
	\tikzstyle{contrast} = [rectangle, draw=black,fill=blue!20, text width=4em, text centered,  minimum height=6em, minimum width=4.5em,font=\small]
	\tikzstyle{block} = [rectangle, text width=2em, text centered, minimum width=3em, minimum height=1em, font=\large]
	...
	\begin{center}
		...
		\onslide*{2,2-}{	
			\node[contrast](contrast1){\\~\\Contrast\\~\\ \footnotesize{Version 2015}};
			\node[block, right= of contrast1](vs){V.S};
			\node[contrast, right= of vs](contrast2){\\~\\Contrast\\~\\ \footnotesize{Version 2018}};}
		\onslide*{4,4-}{
			\node[contrast, right=3cm of contrast2, draw=black](contrast3){\\~\\Contrast\\~\\ \footnotesize{Version 2019}};
			
			\draw[vecArrow] (contrast2) to node[above] {Predict} (contrast3) ;
...
\begin{slide}[toc=,bm=]{Case Study (3) - PR Based Conditional Random Fields}
	\begin{itemize}
		...
		\twocolumn[lcolwidth=0.5\linewidth,rcolwidth=0.5\linewidth,colsep=0.001\linewidth]{
			...
			\begin{center}
				\onslide*{3, 3-}{
					\includegraphics[width=0.7\textwidth]{figures//theme3//Theme3_4_2.eps}
				}
			\end{center}
			...
			\begin{figure}
				\onslide*{4, 4-}{
					\includegraphics[width=0.6\textwidth]{figures//theme3//Theme3_4_3.eps}
				}
			\end{figure}
		}
	\end{itemize}

...
\begin{figure}[htbp]
    \centering
    \subfigure{
        \includegraphics[height=0.30\textwidth,width=0.3\textwidth]{figures//theme1//Theme1_11.eps}
    }
    \subfigure{
    \onslide*{2,2-}{
%   \put(-200,90){
    {\twotonebox{} % \large \textcolor{orange}{?}}
...
%\begin{thebibliography}{}
%\bibitem{}
%\small{Wang, Xiaofeng and Li, Gang and Jiang, Guang and Shi, Zhongzhi.
		...
		\twocolumn[lcolwidth=0.5\linewidth,rcolwidth=0.5\linewidth,colsep=0.001\linewidth]{
			\onslide*{3,3-}{
				\begin{itemize}
					...
					\item
					Trace the trend for predicting
					future potential
...
\begin{slide}[toc=,bm=]{Case Study (3) - PR Based Conditional Random Fields}
	\begin{itemize}
		...
		\twocolumn[lcolwidth=0.45\linewidth,rcolwidth=0.6\linewidth,colsep=0.001\linewidth]{
			...
			\begin{figure}
				\includegraphics[width=0.4\textwidth]{figures//theme3//Theme3_4_1.eps}
			\end{figure}
		}
		\onslide*{2, 2-}{
			\begin{itemize}

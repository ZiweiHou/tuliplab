...
%	TABLE 6. Privacy breach of Singapore residents traveling overseas\protect\footnotemark[1].\\[15pt]
	...
	ID  	&  	\textbf{User(Gender)}		& 		\textbf{Visited Destination} 		& 		\textbf{Venue} 		& 	\textbf{Date} 		&	\textbf{Time}	\\
	\midrule
	\onslide*{2,5}{\textcolor{red}{$L_1$}}\onslide*{-1,3-4}{{$L_1$}}	
	&\onslide*{2,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-1,3-4}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{2,5}{\textcolor{red}{Shanghai, China}}\onslide*{-1,3-4}{{Shanghai, China}} 	
	&\onslide*{2,5}{\textcolor{red}{UNCO Lounge}}\onslide*{-1,3-4}{{UNCO Lounge}}				
	&\onslide*{2,5}{\textcolor{red}{25-May-2015}}\onslide*{-1,3-4}{{25-May-2015}}
	&\onslide*{2.5}{\textcolor{red}{20:17}}\onslide*{-1,3-4}{{20:17}}	\\
			
			
	\onslide*{2,5}{\textcolor{red}{$L_2$}}\onslide*{-1,3-4}{{$L_2$}}	
	&\onslide*{2,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-1,3-4}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{2,5}{\textcolor{red}{Shanghai, China}}\onslide*{-1,3-4}{{Shanghai, China}} 	
	&\onslide*{2,5}{\textcolor{red}{T8 Restaurant and Bar}}\onslide*{-1,3-4}{{T8 Restaurant and Bar}}				
	&\onslide*{2,5}{\textcolor{red}{26-May-2015}}\onslide*{-1,3-4}{{26-May-2015}}
	&\onslide*{2,5}{\textcolor{red}{17:35}}\onslide*{-1,3-4}{{17:35}}	\\		
	
	$L_3$	&$U_5$(M)-$U_6$(F)	&Cannes, France 	       &Villa Mystique Resort		&25-Jun-2015	&11:03\\	
	
	\onslide*{3,5}{\textcolor{red}{$L_4$}}\onslide*{-2,4}{{$L_4$}}	
	&\onslide*{3,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-2,4}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{3,5}{\textcolor{red}{Paris, France }}\onslide*{-2,4}{{Paris, France}} 	
	&\onslide*{3,5}{\textcolor{red}{Dersou Restaurant}}\onslide*{-2,4}{{Dersou Restaurant}}				
	&\onslide*{3,5}{\textcolor{red}{27-Jun-2015}}\onslide*{-2,4}{{27-Jun-2015}}
	&\onslide*{3,5}{\textcolor{red}{19:58}}\onslide*{-2,4}{{19:58}}	\\	
	
	\onslide*{3,5}{\textcolor{red}{$L_5$}}\onslide*{-2,4}{{$L_5$}}	
	&\onslide*{3,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-2,4}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{3,5}{\textcolor{red}{Paris, France }}\onslide*{-2,4}{{Paris, France}} 	
	&\onslide*{3,5}{\textcolor{red}{Ladure Pastry Shop}}\onslide*{-2,4}{{Ladure Pastry Shop}}				
	&\onslide*{3,5}{\textcolor{red}{28-Jun-2015}}\onslide*{-2,4}{{28-Jun-2015}}
	&\onslide*{3,5}{\textcolor{red}{14:48}}\onslide*{-2,4}{{14:48}}	\\			
	...
	\onslide*{4,5}{\textcolor{red}{$L_9$}}\onslide*{-3}{{$L_9$}}	
	&\onslide*{4,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-3}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{4,5}{\textcolor{red}{Ho Chi Minh, Vietnam}}\onslide*{-3}{{Ho Chi Minh, Vietnam}} 	
	&\onslide*{4,5}{\textcolor{red}{MGallery Hotel des Art}}\onslide*{-3}{{MGallery Hotel des Art}}				
	&\onslide*{4,5}{\textcolor{red}{30-Jun-2016}}\onslide*{-3}{{30-Jun-2016}}
	&\onslide*{4,5}{\textcolor{red}{19:54}}\onslide*{-3}{{19:54}}	\\		
	
	
	\onslide*{4,5}{\textcolor{red}{$L_{10}$}}\onslide*{-3}{{$L_{10}$}}	
	&\onslide*{4,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-3}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{4,5}{\textcolor{red}{Ho Chi Minh, Vietnam}}\onslide*{-3}{{Ho Chi Minh, Vietnam}} 	
	&\onslide*{4,5}{\textcolor{red}{L'Usine: Cafe}}\onslide*{-3}{{L'Usine: Cafe}}				
	&\onslide*{4,5}{\textcolor{red}{01-Jul-2016}}\onslide*{-3}{{01-Jul-2016}}
	&\onslide*{4,5}{\textcolor{red}{10:55}}\onslide*{-3}{{10:55}}	\\	
	
	\onslide*{4,5}{\textcolor{red}{${L_11}$}}\onslide*{-3}{{$L_{11}$}}	
	&\onslide*{4,5}{\textcolor{red}{$U_5$(M)-$U_6$(F)}}\onslide*{-3}{{$U_5$(M)-$U_6$(F)}}	
	&\onslide*{4,5}{\textcolor{red}{Ho Chi Minh, Vietnam}}\onslide*{-3}{{Ho Chi Minh, Vietnam}} 	
	&\onslide*{4,5}{\textcolor{red}{Social Club @ Hotel Des Arts}}\onslide*{-3}{{Social Club @ Hotel Des Arts}}				
	&\onslide*{4,5}{\textcolor{red}{01-Jul-2016}}\onslide*{-3}{{01-Jul-2016}}
	&\onslide*{4,5}{\textcolor{red}{17:04}}\onslide*{-3}{{17:04}}	\\		
	\bottomrule
	\end{tabular}
...
\fi
	...
	\onslide*{2,4}{\textcolor{red}{$C_1$}}\onslide*{1,3}{{$C_1$}}	
	&\onslide*{2,4}{\textcolor{red}{$U_9$(M)-$U_{10}$(F)}}\onslide*{1,3}{{$U_9$(M)-$U_{10}$(F)}}	
	&\onslide*{2,4}{\textcolor{red}{Zouk Night Club}}\onslide*{1,3}{{Zouk Night Club}} 	
	&\onslide*{2,4}{\textcolor{red}{11-Sep-2015}}\onslide*{1,3}{{11-Sep-2015}}				
	&\onslide*{2,4}{\textcolor{red}{23:31}}\onslide*{1,3}{{23:31}}\\	
	
	\onslide*{2,4}{\textcolor{red}{$C_2$}}\onslide*{1,3}{{$C_2$}}	
	&\onslide*{2,4}{\textcolor{red}{$U_9$(M)-$U_{10}$(F)}}\onslide*{1,3}{{$U_9$(M)-$U_{10}$(F)}}	
	&\onslide*{2,4}{\textcolor{red}{Zouk Night Club}}\onslide*{1,3}{{Zouk Night Club}} 	
	&\onslide*{2,4}{\textcolor{red}{18-Nov-2015}}\onslide*{1,3}{{18-Nov-2015}}				
	&\onslide*{2,4}{\textcolor{red}{23:50}}\onslide*{1,3}{{23:50}}\\	
		
	$C_3$	&$U_9$(M)-$U_{10}$(F)	 &Club Luxi			&17-Jan-2016	    &00:30\\
	$C_4$	&$U_9$(M)-$U_{10}$(F)	 &Club Hollywood		&06-Feb-2016     &04:34\\
	$C_5$	&$U_9$(M)-$U_{10}$(F)	 &Wave House Sentosa	&12-Mar-2016	    &22:43\\	
	
	\onslide*{3,4-}{\textcolor{red}{$C_6$}}\onslide*{-2}{{$C_6$}}	
	&\onslide*{3,4-}{\textcolor{red}{$U_9$(M)-$U_{10}$(F)}}\onslide*{-2}{{$U_9$(M)-$U_{10}$(F)}}	
	&\onslide*{3,4-}{\textcolor{red}{Zouk Night Club}}\onslide*{-2}{{Zouk Night Club}} 	
	&\onslide*{3,4-}{\textcolor{red}{02-Jul-2016}}\onslide*{-2}{{02-Jul-2016}}				
	&\onslide*{3,4-}{\textcolor{red}{00:25}}\onslide*{-2}{{00:25}}\\	
	
	\onslide*{3,4}{\textcolor{red}{$C_7$}}\onslide*{-2}{{$C_7$}}
	&\onslide*{3,4}{\textcolor{red}{$U_9$(M)-$U_{10}$(F)}}\onslide*{-2}{{$U_9$(M)-$U_{10}$(F)}}
	&\onslide*{3,4}{\textcolor{red}{Zouk Night Club}}\onslide*{-2}{{Zouk Night Club}} 	
	&\onslide*{3,4}{\textcolor{red}{07-Aug-2016}}\onslide*{-2}{{07-Aug-2016}}				
	&\onslide*{3,4}{\textcolor{red}{00:39}}\onslide*{-2}{{00:39}}\\	
	\bottomrule

...
\begin{figure}[htbp]
    ...
    \onslide*{2,2-}{
%   \put(-200,90){
    {\twotonebox{\huge \textcolor{orange}{?}}
...
\begin{slide}[toc=,bm=]{Case Study (3) - PR Based Conditional Random Fields}
	\begin{itemize}
		\item \textbf{Heterogeneous Source}
		
		\vspace{0.5cm}
		\twocolumn[lcolwidth=0.45\linewidth,rcolwidth=0.6\linewidth,colsep=0.001\linewidth]{
			\begin{itemize}
				\item Last decade has seen a growing trend towards creating and managing more profiles in \textit{Online Social Networks}
			\end{itemize}
		}{
			\begin{figure}
...
$\overbrace{Flipper \rightarrow Trainee \rightarrow}^{\text{1 year}} 
\overbrace{Infinity(\infty) \rightarrow}^{\text{2 years}} \cdots$
    \begin{itemize}

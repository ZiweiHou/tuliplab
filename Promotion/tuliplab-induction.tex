...
\begin{slide}[toc=,bm=]{Case Study (2) - Contrast Mining}
	...
	\tikzstyle{block} = [rectangle, text width=2em, text centered, minimum width=3em, minimum height=1em, font=\small]
		...
		\twocolumn[lcolwidth=0.5\linewidth,rcolwidth=0.5\linewidth,colsep=0.001\linewidth]{
			...
			\begin{center}
				...
				\onslide*{4,4-}{
					...
					\draw[vecArrow] (contrast5) to node[above] {Predict} (contrast6) ;

...
%\vspace{1cm}
%\begin{figure}
%    \animategraphics[autoplay, loop, width = 0.5\textwidth,height=0.8\textheight]
%    {1}{figures//gif//aimhigh//a_}{1}{30}
%\end{figure}
%\end{slide}
%%
%==========================================================================================
...
\selectcolormodel{rgb}
\smartdiagramset{description title width=2cm,
set color list={blue!40,orange!70,blue!20},
description title text width=1.75cm,
descriptive items y sep=3.5cm,
description text width=12cm,
module minimum height=.4cm}
...
\selectcolormodel{rgb}
\smartdiagramset{description title width=2cm,
set color list={orange!70,blue!30,blue!20},
description title text width=1.75cm,
descriptive items y sep=3.5cm,
description text width=12cm,
module minimum height=.4cm}

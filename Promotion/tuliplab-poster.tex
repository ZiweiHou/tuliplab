...
\begin{enumerate}
    ...
    \begin{minipage}{0.3\linewidth}
      \centering
      \includegraphics[scale=0.6]{figures//theme1//Theme1_12.eps}
      {Asian Tourist}
    \end{minipage}
    }
    {
    \begin{minipage}{0.3\linewidth}
      \centering
      \includegraphics[scale=0.6]{figures//theme1//Theme1_13.eps}
      {Western Tourist}
    \end{minipage}
    }
  ...
  \begin{minipage}{0.3\linewidth}
    \begin{tikzfigure}
	  \includegraphics[scale=1]{figures//theme1//Theme1_22.eps}
    \end{tikzfigure}
  \end{minipage}

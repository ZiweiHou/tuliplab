...
\begin{document}
	...
	\begin{columns}
		...
		\begin{minipage}{\linewidth}
			\small TULIP is the abbreviation of Team for Universal Learning and Intelligent Processing, a worldly academy. Since 2006, TULIP has started to take Honors students, Master by Research students, and Ph.D. students. 			
			Our research interests include machine learning and data mining, behavior informatics, pattern recognition and data privacy. We have received ARC, CRGS, FaST, DU-UB, HK GRF and HKPU grants since 2006.  Currently, the following web sources are carried out by TULIP team: 
		\end{minipage}	
			...
			\begin{minipage}[l]{0.45\linewidth}
				...
				\begin{description}[font=\small]
					...
					\begin{itemize}
						...
						\item 1 ARC-DP research proposal
					\end{itemize}
		...
		\block[titleleft]{Awards}
		{
			...
			\begin{minipage}{\linewidth}
				...
				\begin{figure}[H]
					...
					\subfigure
					{
						\includegraphics[width=0.95\textwidth]{figures//awards//TULIPAwards2016B.eps}
					}
					\end{minipage}
					...
					\subfigure
					{
						\includegraphics[width=0.95\textwidth]{figures//awards//TULIPAwards2018B.eps}
					}
					\end{minipage}
				\end{figure}	
				\end{minipage}	

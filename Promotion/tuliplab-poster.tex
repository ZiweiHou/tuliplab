...
\begin{itemize}
\item
People share \textcolor{blue}{news, interests}
and \textcolor{blue}{ideas} in OSNs
...
\begin{itemize}
    ...
    \begin{minipage}{0.3\linewidth}
      \centering
      \includegraphics[scale=0.7]{figures//theme1//Theme1_12.eps}
    \end{minipage}}
    {
    \begin{minipage}{0.3\linewidth}
      \centering
      \includegraphics[scale=0.7]{figures//theme1//Theme1_13.eps}
    \end{minipage}
    }
...
%    \begin{minipage}{0.3\linewidth}
% 	 	\begin{tikzfigure}
%			\includegraphics[scale=1.5]{figures//theme1//Theme1_18.eps}
%		 \end{tikzfigure}
%	\end{minipage}	
%
%    \begin{minipage}{0.3\linewidth}
% 	 	\begin{tikzfigure}
%			\includegraphics[scale=1.5]{figures//theme1//pbm_1.eps}
%		 \end{tikzfigure}
%	\end{minipage}
%
%    \begin{minipage}{0.3\linewidth}
% 	 	\begin{tikzfigure}
%			\includegraphics[scale=1.3]{figures//theme1//pbm_2.eps}
%		 \end{tikzfigure}
%	\end{minipage}

    \item
    Case Study(3). Speech Based Emotion Detection

    \begin{minipage}{0.3\linewidth}
 	 	\begin{tikzfigure}
			\includegraphics[scale=1.3]{figures//theme1//Theme1_22.eps}
		 \end{tikzfigure}
	\end{minipage}

    \item
    Case Study(4). K Complex Detection

    \begin{minipage}{0.3\linewidth}
 	 	\begin{tikzfigure}
			\includegraphics[scale=1.3]{figures//theme1//kcd.eps}
		 \end{tikzfigure}
	\end{minipage}
    ...
    \item
    Case Study(5). Trajectory Analysis

		...
		\block[titleleft]{Awards}
		{
			...
			\begin{minipage}{\linewidth}
				...
				\begin{figure}[H]
					...
					\subfigure
					{
						\includegraphics[width=0.86\textwidth]{figures//awards//TULIPAwards2016B.eps}
					}
					\end{minipage}
					\begin{minipage}{\linewidth}
					\subfigure
					{
						\includegraphics[width=0.86\textwidth]{figures//awards//TULIPAwards2014.eps}
					}
					\end{minipage}
				\end{figure}	
				\end{minipage}	
			...
			\scalebox{1}
			{
				\begin{minipage}{\linewidth}
					...
					\small
					\begin{tabular}{ >{\centering}p{0.1\linewidth}  | p{0.52\linewidth} | p{0.16\linewidth}   r }
						\toprule

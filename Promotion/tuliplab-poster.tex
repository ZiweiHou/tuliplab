...
\begin{tikzpicture}[ every annotation/.style = {draw,
                     fill = white}]
  \path[mindmap,concept color=orange!50,font=\sffamily\bfseries,
    every node/.style={concept},
    root/.style    = {concept color=orange!40,
  ...
  node[root,scale=0.6, text=white] {Research Themes} [clockwise from=190]
    child[concept color=mynodecolor, text=black!90] {
...
\block[titleleft]{Publications and Awards}
{
	...
	\begin{minipage}{0.6\linewidth}
		...
		{
			\begin{tikzpicture}
			\begin{axis}[ylabel={number of papers},   x=1.45cm, y=0.6cm, xtick={2006,2008,2010,2012, 2014, 2016, 2018}, ytick={0,2,4,6,8,10,12,14},   x tick label style={rotate=75,anchor=east,/pgf/number format/1000 sep=},
			...
			\addlegendentry{\small{SCI/SSCI Journals}}
			...
			\addlegendentry{\small{Referred Conferences}}
			\end{axis}
			\end{tikzpicture}		
		}		
	\end{minipage}
...
\selectcolormodel{rgb}
   \begin{tikzpicture}[ every annotation/.style = {draw,
                     fill = white}]
  \path[mindmap,concept color=mynodecolor,font=\sffamily\bfseries,
    every node/.style={concept},
    root/.style    = {concept color=mynodecolor,
  ...
  node[root,scale=0.6, text=white] {Research Training} [clockwise from=187]
    child[concept color=orange!30,text=black!90] {
...
\block[titleleft]{Aim High, Soar High \dots}{
	\begin{center}
		\smartdiagramset{description title width=5cm,
			set color list={blue!60,blue!40,blue!20},
...
\colorlet{notebgcolor}{blue!20}
\colorlet{notefrcolor}{blue!20}
\note[targetoffsetx=-13cm, targetoffsety=-78cm,rotate=0,angle=180,radius=8cm,width=.96\textwidth,innersep=.4cm]
{

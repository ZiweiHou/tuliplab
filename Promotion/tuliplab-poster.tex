		...
		\block{Research @ TULIP}{
			...
			\begin{minipage}[l]{0.6\linewidth}
				...
				fill = white}]
					...
					level 1 concept/.append style={font=\bfseries, sibling angle=110,text width=10em,level distance=10em,inner sep=0pt}, 
					level 2 concept/.append style={font=\sf,text width=8em, sibling angle=100, inner sep=0pt, level distance=8em},]

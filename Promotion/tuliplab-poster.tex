...
%					}
		...
		\block[titleleft]{Awards}
		{
			...
			\begin{minipage}{\linewidth}
				...
				\begin{minipage}{\linewidth}
					\centering
					\includegraphics[width=1.03\textwidth]{figures//awards//TULIPAwards2012.eps}
				\end{minipage}
				
				\begin{minipage}{\linewidth}
					\includegraphics[width=1.03\textwidth]{figures//awards//TULIPAwards2007.eps}
				\end{minipage}				
				...
				\begin{figure}[H]
					...
					\subfigure
					{
						\includegraphics[width=0.96\textwidth]{figures//awards//TULIPAwards2016B.eps}
					}
					\end{minipage}
					...
					\subfigure
					{
						\includegraphics[width=0.96\textwidth]{figures//awards//TULIPAwards2018B.eps}
					}
					\end{minipage}
				\end{figure}	
				\end{minipage}	
	...
	\note[targetoffsetx=-13cm, targetoffsety=-24cm,rotate=0, angle=180,radius=8cm,width=.96\textwidth,innersep=.4cm]
	{
		\begin{minipage}{1\linewidth}
			...
			\includegraphics[width=45cm,height=5cm]{logos/tulip-wordmark.eps}
		\end{minipage}
